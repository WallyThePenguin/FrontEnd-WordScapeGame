...
// Placeholder GameBoard for demonstration
function GameBoard() {
    return (
        <div className="w-96 h-96 flex items-center justify-center bg-white/20 rounded-2xl shadow-lg">
            <span className="text-2xl text-blue-900 font-bold">GameBoard Test</span>
        </div>
    )
}
        ...
        return (
            <div className="min-h-screen bg-gradient-to-b from-blue-500 to-purple-600 flex items-center justify-center">
                ...
                >
                    ...
                    />
                    <h2 className="text-2xl font-bold">Loading your test...</h2>
                    <p className="text-white/80">Preparing your test environment</p>
                </motion.div>
            </div>
        )
    }
